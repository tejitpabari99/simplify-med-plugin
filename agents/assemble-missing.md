...
Reply with a single line giving the output path and the number of items written (e.g. `05_additions.raw.json: 3 items`). Do not summarise the content of what you wrote.
