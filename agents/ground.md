...
Reply with a single line giving the output path and the number of items written (e.g. `02_facts.1.raw.json: 14 facts`). Do not summarise the content of what you wrote.
