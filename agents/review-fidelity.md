...
Reply with a single line giving the output path and the number of corrections written (e.g. `04_review.raw.json: 2 corrections`). Do not summarise the content of what you wrote.
